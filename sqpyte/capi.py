...
impl_OP_Halt = rffi.llexternal('impl_OP_Halt', [VDBEP, SQLITE3P, rffi.INTP, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Ne_Eq_Gt_Le_Lt_Ge = rffi.llexternal('impl_OP_Ne_Eq_Gt_Le_Lt_Ge', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Integer = rffi.llexternal('impl_OP_Integer', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Null = rffi.llexternal('impl_OP_Null', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_AggStep = rffi.llexternal('impl_OP_AggStep', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_AggFinal = rffi.llexternal('impl_OP_AggFinal', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Copy = rffi.llexternal('impl_OP_Copy', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_MustBeInt = rffi.llexternal('impl_OP_MustBeInt', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_NotExists = rffi.llexternal('impl_OP_NotExists', [VDBEP, SQLITE3P, rffi.INTP, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_String = rffi.llexternal('impl_OP_String', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_String8 = rffi.llexternal('impl_OP_String8', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Function = rffi.llexternal('impl_OP_Function', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Real = rffi.llexternal('impl_OP_Real', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_RealAffinity = rffi.llexternal('impl_OP_RealAffinity', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Add_Subtract_Multiply_Divide_Remainder = rffi.llexternal('impl_OP_Add_Subtract_Multiply_Divide_Remainder', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_If_IfNot = rffi.llexternal('impl_OP_If_IfNot', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Rowid = rffi.llexternal('impl_OP_Rowid', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_IsNull = rffi.llexternal('impl_OP_IsNull', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_SeekLT_SeekLE_SeekGE_SeekGT = rffi.llexternal('impl_OP_SeekLT_SeekLE_SeekGE_SeekGT', [VDBEP, SQLITE3P, rffi.INTP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Move = rffi.llexternal('impl_OP_Move', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_IfZero = rffi.llexternal('impl_OP_IfZero', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_IdxRowid = rffi.llexternal('impl_OP_IdxRowid', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
...
impl_OP_Seek = rffi.llexternal('impl_OP_Seek', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Once = rffi.llexternal('impl_OP_Once', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_SCopy = rffi.llexternal('impl_OP_SCopy', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Affinity = rffi.llexternal('impl_OP_Affinity', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
...
impl_OP_SorterInsert_IdxInsert = rffi.llexternal('impl_OP_SorterInsert_IdxInsert', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_NoConflict_NotFound_Found = rffi.llexternal('impl_OP_NoConflict_NotFound_Found', [VDBEP, SQLITE3P, rffi.INTP, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
