...
impl_OP_Goto = rffi.llexternal('impl_OP_Goto', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_OpenRead_OpenWrite = rffi.llexternal('impl_OP_OpenRead_OpenWrite', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
...
impl_OP_Halt = rffi.llexternal('impl_OP_Halt', [VDBEP, SQLITE3P, rffi.INTP, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Ne_Eq_Gt_Le_Lt_Ge = rffi.llexternal('impl_OP_Ne_Eq_Gt_Le_Lt_Ge', [VDBEP, SQLITE3P, rffi.INTP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Integer = rffi.llexternal('impl_OP_Integer', [VDBEP, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Null = rffi.llexternal('impl_OP_Null', [VDBEP, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_AggStep = rffi.llexternal('impl_OP_AggStep', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_AggFinal = rffi.llexternal('impl_OP_AggFinal', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Copy = rffi.llexternal('impl_OP_Copy', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_MustBeInt = rffi.llexternal('impl_OP_MustBeInt', [VDBEP, SQLITE3P, rffi.INTP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_NotExists = rffi.llexternal('impl_OP_NotExists', [VDBEP, SQLITE3P, rffi.INTP, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_String = rffi.llexternal('impl_OP_String', [VDBEP, SQLITE3P, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_String8 = rffi.llexternal('impl_OP_String8', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Function = rffi.llexternal('impl_OP_Function', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
...
impl_OP_RealAffinity = rffi.llexternal('impl_OP_RealAffinity', [VDBEP, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Add_Subtract_Multiply_Divide_Remainder = rffi.llexternal('impl_OP_Add_Subtract_Multiply_Divide_Remainder', [VDBEP, rffi.INT, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_If_IfNot = rffi.llexternal('impl_OP_If_IfNot', [VDBEP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Rowid = rffi.llexternal('impl_OP_Rowid', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_IsNull = rffi.llexternal('impl_OP_IsNull', [VDBEP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_SeekLT_SeekLE_SeekGE_SeekGT = rffi.llexternal('impl_OP_SeekLT_SeekLE_SeekGE_SeekGT', [VDBEP, SQLITE3P, rffi.INTP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Move = rffi.llexternal('impl_OP_Move', [VDBEP, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_IfZero = rffi.llexternal('impl_OP_IfZero', [VDBEP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_IdxRowid = rffi.llexternal('impl_OP_IdxRowid', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_IdxLE_IdxGT_IdxLT_IdxGE = rffi.llexternal('impl_OP_IdxLE_IdxGT_IdxLT_IdxGE', [VDBEP, rffi.INTP, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Seek = rffi.llexternal('impl_OP_Seek', [VDBEP, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_Once = rffi.llexternal('impl_OP_Once', [VDBEP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
...
impl_OP_Affinity = rffi.llexternal('impl_OP_Affinity', [VDBEP, SQLITE3P, VDBEOPP],
    lltype.Void, compilation_info=CConfig._compilation_info_)
impl_OP_OpenAutoindex_OpenEphemeral = rffi.llexternal('impl_OP_OpenAutoindex_OpenEphemeral', [VDBEP, SQLITE3P, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_MakeRecord = rffi.llexternal('impl_OP_MakeRecord', [VDBEP, SQLITE3P, rffi.INT, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_SorterInsert_IdxInsert = rffi.llexternal('impl_OP_SorterInsert_IdxInsert', [VDBEP, SQLITE3P, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_NoConflict_NotFound_Found = rffi.llexternal('impl_OP_NoConflict_NotFound_Found', [VDBEP, SQLITE3P, rffi.INTP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_RowSetTest = rffi.llexternal('impl_OP_RowSetTest', [VDBEP, SQLITE3P, rffi.INTP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Gosub = rffi.llexternal('impl_OP_Gosub', [VDBEP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
impl_OP_Return = rffi.llexternal('impl_OP_Return', [VDBEP, rffi.INT, VDBEOPP],
    rffi.INT, compilation_info=CConfig._compilation_info_)
